...
@section('content')
    <div class="row justify-content-center" style="margin-bottom: 35px;">
        ...
        @endif
        <div>
            <a href="{{ URL::previous() }}" class="text-black btn"><i class="fas fa-arrow-left mr-2"></i>
                Kembali</a>
        </div>
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center justify-content-center">
                    <div class="col">
                        ...
                        <h3 class="font-weight-bold">{{ $data->order_id }}</h3>
                    </div>
                    <div class="col-auto">
                        {!! DNS1D::getBarcodeHTML($data->order_id, 'C128', 1.2, 45) !!}
                    </div>
                </div>
                <p style="margin-bottom: 0; margin-top: 5px;">Jadwal Berangkat</p>
                <h5 class="font-weight-bold text-center">
                    <div>
                        {{ date('l, d F Y', strtotime($data->rute->tanggal_keberangkatan)) }}
                    </div>
                    <div>
