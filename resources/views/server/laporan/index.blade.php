                    ...
                    <tbody>
                        @foreach ($order as $data)
                            <tr>
                                ...
                                <td>
                                    <h5 class="card-title">{!! DNS1D::getBarcodeHTML($data->order_id, 'C128', 2, 30) !!}</h5>
                                    <p class="card-text">
                                ...
                                <td>
                                    <h5 class="card-title">
                                        {{ date('l, d F Y', strtotime($data->rute->tanggal_keberangkatan)) }}</h5>
                                    <p class="card-text">
                                        <small class="text-muted">
                                ...
                                <td>
                                    <a href="{{ route('detailTicketAdmin', $data->order_id) }}"
