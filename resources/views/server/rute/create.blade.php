                    ...
                    @foreach ($category as $item)
                        <div class="tab-pane fade{{ $loop->first ? ' show active' : '' }}" id="{{ $item->slug }}"
                            ...
                            @if ($item->name == 'Bus' || $item->name == 'BUS')
                                <form id="{{ $item->slug }}Form" action="{{ route('rute.store') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="select2 form-control" id="transportasi_id" name="transportasi_id"
                                                ...
                                                @foreach ($transportasiBus as $data)
                            ...
                            @elseif (
                                ...
                                <form id="{{ $item->slug }}Form" action="{{ route('rute.store') }}" method="POST">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label for="transportasi_id">Transportasi</label><br>
                                            <select class="select2 form-control" id="transportasi_id"
                                                name="transportasi_id" required style="width: 100%; color: #6e707e;">
                                                <option value="" disabled selected>-- Pilih Transportasi --</option>
                                                @foreach ($transportasiKereta as $data)
                                                    <option value="{{ $data->id }}">{{ $data->kode }} -
                                                        {{ $data->name }} -
                                                        {{ $data->kelas->name }}
                                                    </option>
